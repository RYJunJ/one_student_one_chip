...
static int decode_exec(Decode *s) {
  ...
  INSTPAT_START();
  INSTPAT("0000000 ????? ????? 000 ????? 01100 11", add    , R, R(dest) = BITS((src1 + src2), 31, 0));
  INSTPAT("0000000 ????? ????? 000 ????? 01110 11", addw   , R, R(dest) = SEXT(BITS((src1 + src2), 31, 0), 32););
  INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub    , R, R(dest) = BITS((src1 - src2), 31, 0));
  INSTPAT("0100000 ????? ????? 000 ????? 01110 11", subw   , R, R(dest) = SEXT(BITS((src1 - src2), 31, 0), 32););
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(dest) = BITS((src1 * src2), 31, 0));
  INSTPAT("0000001 ????? ????? 000 ????? 01110 11", mulw   , R, R(dest) = SEXT(BITS((src1 * src2), 31, 0), 32););
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(dest) = SEXT(BITS((src1 / src2), 31, 0), 32););
  INSTPAT("??????? ????? ????? 110 ????? 01110 11", remw   , R, R(dest) = (int64_t)(BITS((src1 % src2), 31, 0)));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   , R, R(dest) = SEXT((BITS(((BITS(src1, 31, 0))>>(src2)), 31, 0)), 32););
  ...
  INSTPAT("??????? ????? ????? ??? ????? 11011 11", jal    , J, R(dest) = s->pc + 0x4; s->dnpc = s->pc + imm;);
  ...
  INSTPAT("??????? ????? ????? 000 ????? 11001 11", jalr   , I, R(dest) = s->pc + 0x4; s->dnpc = ((src1 + imm) & 18446744073709551614ull););
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = SEXT((((int32_t)(BITS(src1, 31, 0)))>>((int32_t)(BITS(imm, 5, 0)))), 32););
